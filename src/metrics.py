...
def build_wyscout_peers(
    ...
    out = {
        ...
        'loose_duels_p90':     ser('Loose ball duels per 90'),
        'loose_duel_win':      ser('Loose ball duels won, %'),
        'slide_tackles_p90':   ser('Sliding tackles per 90'),
        'slide_tackle_pct':    ser('Successful sliding tackles, %'),
        ...
        'clearances_p90':      ser('Clearances per 90'),
        ...
        'avg_pass_length':     ser('Average pass length, m'),
...
_COMPARABLE_FEATURE_MAP: Dict[str, str] = {
    ...
    'xG per 90':                          'xg_p90',
    'xA per 90':                          'xa_p90',
    'Shot assists per 90':                'shot_asts_p90',
    'Touches in box per 90':              'touches_box_p90',
    'Offensive duels per 90':             'off_duels_p90',
    'Offensive duels won, %':             'off_duel_win',
    'Passes per 90':                      'passes_p90',
    'Accurate passes, %':                 'pass_acc',
    'Passes to final third per 90':       'ptf3_p90',
...
_POSITION_WEIGHTS: Dict[str, Dict[str, float]] = {
    ...
    'Full Back': {
        ...
        'Dribbles per 90':                    2.5,
        'Offensive duels per 90':             2.0,
        'Offensive duels won, %':             2.0,
        'Accurate passes, %':                 2.0,
        'Passes per 90':                      1.5,
        'xA per 90':                          1.5,
        'Assists per 90':                     1.5,
        ...
        'Goals per 90':                       0.5,
        'xG per 90':                          0.5,
        'Touches in box per 90':              0.5,
    },
    'Central Mid': {
        'Passes per 90':                      3.0,
        'Accurate passes, %':                 2.5,
        'Progressive runs per 90':            2.5,
        'Passes to final third per 90':       2.0,
        'Successful defensive actions per 90':2.0,
        ...
        'Defensive duels per 90':             1.5,
        'Defensive duels won, %':             1.5,
        'Offensive duels per 90':             1.5,
        'Offensive duels won, %':             1.5,
        'Aerial duels per 90':                0.5,
        'Aerial duels won, %':                0.5,
        'Goals per 90':                       1.0,
        'xG per 90':                          1.0,
        'Touches in box per 90':              0.8,
    },
    'Att Mid': {
        'xA per 90':                          3.0,
        'Assists per 90':                     2.5,
    ...
    'Center Forward': {
        ...
        'Offensive duels per 90':             2.5,
        'Offensive duels won, %':             2.5,
        'Assists per 90':                     2.0,
        'xA per 90':                          2.0,
        'Shot assists per 90':                2.0,
        'Dribbles per 90':                    1.5,
        ...
        'Passes to final third per 90':       0.5,
        'Passes per 90':                      0.5,
        'Accurate passes, %':                 0.5,
        'Defensive duels per 90':             0.3,
        'Defensive duels won, %':             0.3,
    ...
    'Goalkeeper': {
        ...
        'xA per 90':                          0.0,
        'Dribbles per 90':                    0.0,
        'Shot assists per 90':                0.0,
        'Touches in box per 90':              0.0,
        'Offensive duels per 90':             0.0,
        'Offensive duels won, %':             0.0,
        'Passes to final third per 90':       0.0,
    },
}
